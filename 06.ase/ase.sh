...
perl 01.aseTest.pl SRR13051360.split.bam /home/chenqiuming/ljq/07.ase/01.binom  ##/home/chenqiuming/ljq/07.ase/01.binom is absolute directory for output
perl 02.populationLevel.pl PRJNA626458.muscle.list All.anno.gz PRJNA626458.muscle.pop ##PRJNA626458.muscle.list is a list file containing the absolute directory of each sample in subset, All.anno.gz is the annoation file supplied by ANNOVAR, PRJNA626458.muscle.pop is the output in population level
