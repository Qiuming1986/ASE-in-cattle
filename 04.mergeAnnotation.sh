...
perl /home/data/python3/software/annovar/table_annovar.pl All.clean.SNP.vcf.gz /home/data/python3/software/annovar/UCDdb/ -out All -buildver UCD1.2UseName -protocol refGene -operation g -nastring . -vcfinput
